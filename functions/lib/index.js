...
exports.analyzeText = (0, https_1.onRequest)({
    ...
    try {
        ...
        console.log('API Key valid format:', (apiKey === null || apiKey === void 0 ? void 0 : apiKey.startsWith('sk-')) || false);
...
Return only valid JSON array format. Do not wrap in markdown code blocks.`;
        ...
        console.log('Response length:', (aiResponse === null || aiResponse === void 0 ? void 0 : aiResponse.length) || 0);
        if (!aiResponse) {
